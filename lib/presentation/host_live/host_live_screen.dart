        ...
        child: Scaffold(
          ...
          body: Stack(
            ...
            children: [
              ...
              Obx(() => controller.streamStatus.value == StreamStatus.offline &&
...
/// Fades and disables its child based on [HostLiveController.showControls].
/// Kept inside each Positioned so the Stack still sees a direct Positioned.
class _FadeControls extends GetView<HostLiveController> {
  final Widget child;
  const _FadeControls({required this.child});
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        ...
                        Obx(() => StreamingTimer(
                            elapsed: controller.elapsedDisplay.value)),
                        const SizedBox(width: 8),
                        Obx(() => ViewerCountWidget(
                            count: controller.viewerCount.value)),
                        const SizedBox(width: 8),
                        Obx(() => NetworkQualityWidget(
                            quality: controller.networkQuality.value)),
                      ],
                    ),
                  ),
                ),
        ...
        child: Column(
          children: [
            Obx(() => _RtmpStatusChip(
                  ...
                  platform: controller.stream?.platform.name.capitalizeFirst ??
                      'Stream',
                )),
